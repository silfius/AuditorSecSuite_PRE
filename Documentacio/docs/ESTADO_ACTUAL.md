...
## Bloque 8A — catálogo inicial de checks seguros

Se inicia la semilla declarativa del catálogo inicial de checks seguros. El objetivo es que las auditorías puedan planificar controles recurrentes sin ejecutar motores ni llamadas técnicas.
...
## Bloque 8B — aplicabilidad de checks por tipo de activo

Se añade control para impedir planificaciones incoherentes entre tipo de activo y check seguro.
