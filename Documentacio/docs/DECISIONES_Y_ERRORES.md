...
### Decisión — aplicabilidad validada en backend

La aplicabilidad de checks no queda delegada solo al formulario. Se valida en `AuditCheckPlan.clean()` para bloquear combinaciones incoherentes incluso si se manipula el POST.
